...
import {
  script as script13
} from "./chunk-M7JWCEBP.js";
import {
  script as script9
} from "./chunk-U7BH5R4R.js";
import {
  script as script10
} from "./chunk-ARIO4TTD.js";
import {
  script as script11
} from "./chunk-AIYILXD2.js";
import {
  script as script8
  ...
  methods: {
    ...
    findSelectedNodes: function findSelectedNodes(node2, keys, selectedNodes2) {
      if (node2) {
        ...
        var _iterator2 = _createForOfIteratorHelper2(this.options), _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
    ...
    updateTreeState: function updateTreeState() {
      var keys = _objectSpread$12({}, this.modelValue);
      this.expandedKeys = {};
    ...
    updateTreeBranchState: function updateTreeBranchState(node2, path, keys) {
      if (node2) {
        ...
        var _iterator4 = _createForOfIteratorHelper2(this.options), _step4;
        try {
...
var _hoisted_12 = ["id", "disabled", "tabindex", "aria-labelledby", "aria-label", "aria-expanded", "aria-controls"];
var _hoisted_22 = ["aria-expanded"];
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _objectSpread2(_objectSpread2({}, _ctx.inputProps), _ctx.ptm("hiddenInput"))), null, 16, _hoisted_12)], 16), createBaseVNode("div", mergeProps({
  ...
  })], 16, _hoisted_22), createVNode(_component_Portal, {
