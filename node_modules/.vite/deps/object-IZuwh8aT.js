...
function F(e, t = "", n = {}) {
	...
	if (r) {
		if (i(e)) return F(m(e[Object.keys(e).find((f) => g(f) === r) || ""], n), o.join("."), n);
		return;
	}
	return m(e, n);
}
...
//#endregion
export { q as C, z as D, w as E, p as S, s as T, i as _, H as a, m as b, O as c, Y as d, a as f, h as g, g as h, G as i, W as l, ee as m, C as n, J as o, c as p, F as r, M as s, B as t, X as u, k as v, re as w, ne as x, l as y };

//# sourceMappingURL=object-IZuwh8aT.js.map