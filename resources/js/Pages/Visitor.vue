...
<template>
    ...
    <div class="relative min-h-screen bg-slate-50 flex items-center justify-center p-4 overflow-hidden font-sans">
        ...
        <div class="absolute top-[-10%] left-[-10%] w-96 h-96 bg-primary-400 rounded-full mix-blend-multiply filter blur-[100px] opacity-30 animate-blob"></div>
        <div class="absolute top-[20%] right-[-10%] w-96 h-96 bg-blue-400 rounded-full mix-blend-multiply filter blur-[100px] opacity-30 animate-blob animation-delay-2000"></div>
        <div class="absolute bottom-[-20%] left-[20%] w-96 h-96 bg-indigo-400 rounded-full mix-blend-multiply filter blur-[100px] opacity-30 animate-blob animation-delay-4000"></div>
        ...
        <div class="relative z-10 w-full max-w-4xl quantum-entrance">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12">
                    ...
                    <div class="lg:col-span-7 p-8 lg:p-12 flex flex-col justify-center">
                        ...
                        <div class="flex items-center gap-4 mb-8">
                            <div class="w-14 h-14 bg-primary-600 rounded-2xl flex items-center justify-center shadow-lg shadow-primary-200">
                                <i class="pi pi-bolt text-white text-2xl"></i>
                            </div>
                            <div>
                                <h2 class="text-sm font-black text-slate-400 uppercase tracking-widest">Portail GMAO</h2>
                                <h1 class="text-2xl font-black text-slate-800 tracking-tight">MaintenX Enterprise</h1>
                            </div>
                        </div>

                        <!-- Titre d'accueil -->
                        <h3 class="text-4xl font-black text-slate-900 leading-tight mb-4">
                            Bienvenue, <span class="text-primary-600">{{ props.user?.name || 'Visiteur' }}</span> ! 🎉
                        </h3>
                        ...
                        <div class="bg-blue-50 border border-blue-100 rounded-2xl p-5 mb-8 flex gap-4">
                            ...
                            <div>
                                <h4 class="text-sm font-black text-blue-900 uppercase tracking-wider mb-1">Élévation des privilèges</h4>
                        ...
                        <div class="flex flex-wrap items-center gap-4">
                            <Button label="Vérifier mon statut" icon="pi pi-refresh" class="p-button-primary !rounded-xl font-bold shadow-lg shadow-primary-200 px-6 py-3" @click="checkStatus" />
                    ...
                    <div class="lg:col-span-5 bg-slate-900 p-8 lg:p-12 text-white flex flex-col justify-center relative overflow-hidden">
                        ...
                        <div class="absolute top-0 right-0 w-64 h-64 bg-primary-500 rounded-full mix-blend-screen filter blur-[80px] opacity-20"></div>
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="flex justify-between items-end mb-2">
                                ...
                                <span class="text-sm font-bold text-primary-400">{{ progress }}%</span>
                            </div>
                            <ProgressBar :value="progress" :showValue="false" class="!h-2 !bg-slate-800 mb-10">
                                <template #default>
                                    <div class="h-full bg-gradient-to-r from-primary-500 to-blue-400 rounded-full" :style="{width: progress + '%'}"></div>
                                </template>
                            </ProgressBar>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center gap-4 opacity-50">
                                    ...
                                    <div class="flex flex-col">
                                        <span class="text-xs font-bold text-white">Tableaux de bord KPIs</span>
                                        <span class="text-[10px] text-slate-500">Statistiques en temps réel</span>
                                    </div>
                                ...
                                <div class="flex items-center gap-4 opacity-50">
                                    ...
                                    <div class="flex flex-col">
                                        <span class="text-xs font-bold text-white">Gestion des Interventions</span>
                                        <span class="text-[10px] text-slate-500">Création et suivi des bons</span>
                                    </div>
                                    <i class="pi pi-lock text-slate-600 ml-auto text-xs"></i>
                                </div>
                                ...
                                <div class="flex items-center gap-4 opacity-50">
                                    ...
                                    <div class="flex flex-col">
                                        <span class="text-xs font-bold text-white">Télémétrie Équipements</span>
                                        <span class="text-[10px] text-slate-500">Transformateurs & Réseaux</span>
                                    </div>
                                    <i class="pi pi-lock text-slate-600 ml-auto text-xs"></i>
                                </div>
                            </div>
            ...
            <div class="text-center mt-6">
                <p class="text-xs font-bold text-slate-400 uppercase tracking-widest">
                    Besoin d'aide urgente ? <a href="mailto:support@maintenx.com" class="text-primary-500 hover:text-primary-600 transition-colors">Contactez le support</a>
                </p>
            </div>
